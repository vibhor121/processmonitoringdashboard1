...
echo -e "     cd process_monitor/backend"
echo -e "     mkdir -p staticfiles"
echo -e "     python manage.py collectstatic --noinput"
echo -e "     python manage.py migrate"
echo -e "   - Start Command:"
echo -e "     cd process_monitor/backend && gunicorn process_monitor_backend.wsgi:application --bind 0.0.0.0:\$PORT --workers 2 --timeout 120"
